          ...
          <section className="mb-5">
            ...
            <div className="bg-light p-4 rounded-3 mb-4">
              ...
              <ul>
                ...
                <li>
                  <strong>CSS Interno:</strong> En la sección &lt;style&gt;
                  dentro del &lt;head&gt;
                </li>
                <li>
              ...
              <ul>
                ...
                <li>
                  <code>[atributo]</code> - Selecciona elementos con ese
                  atributo
                </li>
              </ul>
            </div>
          ...
          <section className="mb-5">
            ...
            <div className="bg-light p-4 rounded-3 mb-4">
              ...
              <ul>
                ...
                <li>
                  <strong>Padding:</strong> Espacio entre el contenido y el
                  borde
                </li>
                <li>
            ...
            <Card className="shadow border-0 p-4">
              <Card.Body>
                ...
                <p className="fs-5 mb-4">
                  Para acceder al contenido completo sobre los conceptos básicos
                  de CSS, propiedades esenciales, modelo de caja, Flexbox, Grid
                  y animaciones, inicia sesión o regístrate.
                </p>
